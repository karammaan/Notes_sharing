...
public class sign_up_layout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_et = (EditText) findViewById(R.id.edit_username);
    ...
    public void signup(View v)
    {
        ...
        if(name.equals(""))
        {
            ...
            Toast.makeText(sign_up_layout.this , "enter your name" , Toast.LENGTH_SHORT).show();
        ...
        JsonObjectRequest jobjreq = new JsonObjectRequest("http://192.168.0.17/signup_notes_sharing.php",
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    if(response.getString("key").equals("0"))
                    {
                        ...
                        Toast.makeText(sign_up_layout.this ,"done" , Toast.LENGTH_SHORT).show();

                    }

                    else {
                        Toast.makeText(sign_up_layout.this ,"error" , Toast.LENGTH_SHORT).show();
